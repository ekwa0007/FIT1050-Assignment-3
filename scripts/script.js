$('#cs-navigation .cs-li-link').hover(function () {
    $(this).parent().css({
...
$(document).ready(function () {
    $("#cs-navigation .cs-li").click(function () {
        $("#cs-navigation .cs-li-link.cs-active").removeClass("cs-active");
        $("#cs-navigation .cs-li").removeClass("cs-active");
